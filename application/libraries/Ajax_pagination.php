 ...
 */
$pag_container_open = "<div class='pagination-area mt-30 mb-20'><nav aria-label='Page navigation example'><ul class='pagination justify-content-center'>";
...
class Ajax_pagination
{
   ...
   var $first_link      = '<<';
   var $next_link      = '<i class="fas fa-arrow-right"></i>';
   var $prev_link      = '<i class="fas fa-arrow-left"></i>';
   var $last_link      = '>>';
   var $uri_segment   = 3;

   var $full_tag_open   = "<div class='pagination-area mt-30 mb-30'><nav><ul class='pagination justify-content-center'>";
   ...
   var $cur_tag_open   = '<li class="page-item active"><a class="page-link" href="javascript:void(0);">';
   var $cur_tag_close   = '</li></a>';
   ...
   function create_links()
   {
      ...
      if ($num_pages == 1) {
         $info = '<span>Mostrando : ' . $this->total_rows.'</span>';
         return $info;
      }
      ...
      if ($this->show_count) {
         ...
         $info = '<li class="li-css"><p class="info-pagination"><i class="fi-rs-shopping-bag mr-10"></i>Mostrando ' . ($curr_offset + 1) . ' al ';

         if (($curr_offset + $this->per_page) < ($this->total_rows - 1))
            $info .= $curr_offset + $this->per_page.'</p></li>';
         else
