               ...
               <div class="get-touch-area pl-50 pr-50">
                  ...
                  <div class="row " style="text-align: justify;">
                     <div class="col-xl-12 col-lg-12 col-md-12">
                        ...
                        <p>
                           <br>Un defecto cardíaco congénito ocurre cuando el corazón o los vasos sanguíneos próximos al
                        ...
                        <p>
                           <br>Este tipo de malformaciones puede aparecer de forma aislada o aparecer en el contexto de
                        ...
                        <p>
                           <br>La gran mayoría de las cardiopatías no puede limitarse a una sola causa, como una
                        ...
                        <P>
                           <br>Dado que existe un amplio número de malformaciones descritas en el presente artículo solo
                        ...
                        <p>
                           <br>Durante la vida intrauterina, la ciruclación sanguínea es diferente debido a que el
                        ...
                        <p>
                           <br>Al momento del nacimiento, cuando los pulmones se convierten en los órganos que oxigenan
                        ...
                        <p>
                           <br>Las manifestaciones clínicas de la persistencia del conducto arterioso dependen
                        ...
                        <p>
                           <br>El diagnóstico de esta malformación se realiza a través del ecocardiograma, sobre todo en
                        ...
                        <p>
                           <br>Con respecto al tratamiento, en algunos casos el conducto arterioso puede cerrarse de
                        ...
                        <p>
                           <br>Esta cardiopatía congénita se caracteriza por un defecto en la pared que separa ambas
                        ...
                        <p>
                           <br>Los pacientes con defecto del septum auricular habitualmente son asintomáticos. Los
                        ...
                        <p>
                           <br>El diagnóstico de esta malformación se puede realizar con el ecocardiograma transtorácico
                        ...
                        <p>
                           <br>El tratamiento de esta malformación consiste en el cierre del defecto. Este puede
                        ...
                        <p>
                           <br>Se puede sospechar este defeto en niños en los que se detecta un soplo holosistólico en
                        ...
                        <p>
                           <br>El diagnóstico se realiza con el ecocardiograma, el cual puede localizar y caracterizar
                           el defecto.
                        </p>
                        <p>
                           <br>El tratamiento puede incluir el cierre del defecto a través de cateterismo o de cirugía
                        ...
                        <p>
                           <br>Las tres malformaciones mencionadas previamente son las más frecuentes, y no resulta
                        ...
                        <p>
                           <br>La palabra “tetralogía” surge de dos términos griegos que se traducen en “cuatro
                        ...
                        <p>
                           <br>Esta cardiopatía congénita se compone de cuatro malformaciones que se mencionan a
                           continuación:
                        </p>
                        <p class="sangria">
                           <br>1. Defecto del septum ventricular
                           <br>2. Un impedimento del flujo de la sangre del corazón hacia los pulmones (“atresia
                           pulmonar”)
                           <br>3. La aorta, mal posicionada, se encuentra sobre el orificio de salida entre los
                           ventrículos.
                           <br>4. El músculo del ventrículo derecho engrosado
                        </p>
                        <p>
                           <br>La obstrucción en la válvula pulmonar (salida del corazón hacia los pulmones) impide que
                        ...
                        <p>
                           <br>Esta malformación se sospecha en niños con cianosis (coloración azulada de la piel),
                        ...
                        <p>
                           <br>Los bebés y niños pequeños con tetralogía no reparada de Fallot a menudo son azules,
                        ...
                        <p class="sangria">
                           <br>1. Mendieta-Alcántara GG. et al (2013) Incidencia de las cardiopatías congénitas y los
