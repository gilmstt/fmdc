                    ...
                    <div class="row " style="text-align: justify;">
                        ...
                        <h1><br>¿Cómo se diagnostica la hipertensión pulmonar?</h1> 
                            ...
                            <p class="sangria">
                                ...
                                <br>3.	Pruebas de funcionamiento pulmonar (espirometría, medición de volúmenes pulmonares, capacidad de difusión)
                            ...
                            <p>
                              <br>Es importante mencionar que el cateterismo cardíaco derecho es el único estudio capaz de confirmar al 100% la sospecha clínica, sin embargo su uso es reservado al tratarse de un procedimiento invasivo. 
                            </p>
                            <h1><br>¿Cómo se trata la hipertensión pulmonar?</h1> 
                            <p>
                            <br>No existe un solo tratamiento para la hipertensión pulmonar, sino que el tratamiento habitualmente es multidisciplinario. El tratamiento depende de la causa. La mayoría de los tratamientos existentes que son específicos para hipertensión pulmonar, están dirigidos a tratar la hipertensión pulmonar del grupo 1. El resto de los grupos de hipertensión pulmonar ameritan un tratamiento de las causas desencadenantes como la insuficiencia cardíaca, la enfermedad valvular cardíaca, la enfermedad tomboembólica crónica, el síndrome de apnea obstructiva del sueño , etc.
                            </p>
                            <h1><br>¿Cuál es el pronóstico de un paciente con diagnóstico de hipertensión pulmonar?</h1> 
                            <p>
                             <br>La hipertensión pulmonar es una enfermedad grave. Desgraciadamente, la enfermedad empeora gradualmente y es probable que termine por imposibilitar llevar una vida cotidiana. Cuando se presenta en niños, la enfermedad podría mejorar con el tiempo en algunos casos.
                            </p>
                            <p>
                                <br>Los medicamentos y el oxígeno podrían hacer que se sienta mejor y viva más tiempo. No obstante, la mortalidad que se mantiene en torno al 50% a los cinco años posteriores al diagnóstico. Cabe destacar que este porcentaje ha mejorado significativamente en las últimas dos décadas, y se espera que se incremente aún más en los años siguientes.
                            </p>

                            
                        <h1><br>Referencias:</h1> 
                        <p class="sangria">
                            <br>1.	UpToDate (2019) Patient Education (The Basics)Fecha de revision 08/08/2019 Visto en: https://www.uptodate.com/contents/pulmonary-hypertension-the-basics?search=pulmonary%20hypertension%20basics&source=search_result&selectedTitle=2~150&usage_type=default&display_rank=2
                            <br>2.	Thenappan, T., Ormiston, M. L., Ryan, J. J., & Archer, S. L. (2018). Pulmonary arterial hypertension: pathogenesis and clinical management. BMJ.
                            <br>3.	Kiely, D. G., Elliot, C. A., Sabroe, I., & Condliffe, R. (2013). Pulmonary hypertension: diagnosis and management. BMJ.
                            <br>4.	Farber, H. W., & Loscalzo, J. (2004). Pulmonary Arterial Hypertension. New England Journal of Medicine, 351(16), 1655–1665.
                            <br>5.	McGoon, M.D & Kane, G. C. (2009) Pulmonary Hypertension: Diagnosis and ManagementMayo Clin Proc. 84(2):191-207.
                        </p>
