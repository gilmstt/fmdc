            ...
            <div class="col-xl-8 offset-xl-2">
                <div class="page-title-wrapper text-center pt-125">
                    <div class="page-title-box">
                        <h2 class="page-title">Rayos x</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="get-touch-area pl-50 pr-50">
                    <div class="section-title text-left mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                        <h6><span><i class="fas fa-heart"></i></span>Rayos x</h6>
                    </div>
                    <div class="row " style="text-align: justify;">
                        ...
                        <p>
                            ...
                            <br><br>Red JC. Radiología torácica. Patrones radiológicos y diagnóstico diferencial, Ed. Doyma, Barcelona, España, 1993.
                        </p>
