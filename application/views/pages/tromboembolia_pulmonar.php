            ...
            <div class="col-xl-8 offset-xl-2">
                <div class="page-title-wrapper text-center pt-125">
                    <div class="page-title-box">
                        <h2 class="page-title">Tromboembolia Pulmonar</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="get-touch-area pl-50 pr-50">
                    <div class="section-title text-left mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                        <h6><span><i class="fas fa-heart"></i></span>TROMBOEMBOLIA PULMONAR</h6>
                    </div>
                    <div class="row " style="text-align: justify;">
                        ...
                        <p>
                            <br>El presente artículo respornderá las principales preguntas relacionadas con la tromboembolia pulmonar (TEP). ¿Qué es la TEP? ¿Cómo sucede? ¿Qué factores favorecen que una persona tenga una TEP? ¿Qué síntomas se presentan? ¿Cómo se diagnostica? ¿Cómo se trata? y finalmente ¿Cuál es el pronóstico después de haber tenido una TEP?
                        </p>
                        
                        <h1><br>¿Qué es la TEP? </h1>
                        ...
                        <p>
                            <br>En situaciones en las que se sabe de antemano que habrá una disminución en la movilidad (como previo a un vuelo, o durante de una jornada de oficina) es recomendable implementar algunas medidas protectoras de la formación de coágulos en las extremidades inferiores: 
                        </p>

                        <p class="sangria">
                            <br>•	Mover frecuentemente las piernas y los pies, y cambiar constantemente de posición al estar sentado
                            <br>•	Levantarse a caminar un poco cada 1 a 2 horas
                            <br>•	Considerar el uso de medias de compresión
                            <br>•	Abstenerse de fumar justo antes de algún viaje
                        </p>
                            
                        <p>
                            <br>Recuerde lo valioso que es su corazón y su vida, cuide su salud para prevenir una TEP.
                        </p>

                        <p class="col-xl-12 col-lg-12 col-md-12" style="margin-left: -16px;"><br>Por un corazón sano, Fundación Mexicana del Corazón.</p>
                            
                            
                        <h1><br>Referencias:</h1> 
                        <p class="sangria">
                            <br>1.	Sabatine, Marc S. (2017) Pocket Medicine. 6th Edition. Wolters Kluwer.
                            <br>2.	2014 ESC Guidelines on the diagnosis and management of acute pulmonary embolism. (2014). European Heart Journal, 35(43), 3033–3073.
                            <br>3.	Ortel TL, Neumann I, Ageno W, et al. American Society of Hematology (2020) Guidelines for management of venous thromboembolism: treatment of deep vein thrombosis and pulmonary embolism. Blood Adv 2020; 4:4693.
                            <br>4.	Neumann, Ignacio., Izcovich, Ariel, et al. (2021) ASH, ABHH, ACHO, Grupo CAHT, Grupo  CLAHT, SAH, SBHH, SHU, SOCHIHEM, SOMETH, Sociedad Panameña de Hematología, SPH, and SVH 2021 guidelines for management of venous thromboembolism in Latin America. Blood Adv (2021) 5 (15): 3032–3046
                            <br>5.	Ageno, W., Konstantinides, S. V., & Schulman, S. (2017). Venous thromboembolism: Past, present and future. Thrombosis and Haemostasis, 117(07), 1219–1229.
                            <br>6.	Wolberg, A. S., Rosendaal, F. R., Weitz, J. I., Jaffer, I. H., Agnelli, G., Baglin, T., & Mackman, N. (2015). Venous thrombosis. Nature Reviews Disease Primers, 15006
                        </p>
