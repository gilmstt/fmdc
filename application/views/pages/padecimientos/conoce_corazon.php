            ...
            <div class="col-xl-8 offset-xl-2">
                <div class="page-title-wrapper text-center pt-125">
                    <div class="page-title-box">
                        <h2 class="page-title">Anatomía y Función</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12">
                <div class="get-touch-area pl-50 pr-50">
                    <div class="section-title text-left mb-30 wow fadeInUp2 animated" data-wow-delay='.1s'>
                        <h6><span><i class="fas fa-heart"></i></span>Anatomía y Función</h6>
                    </div>
                    <div class="row " style="text-align: justify;">
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            ...
                            <p class="sangria">
                                    <br>-Anderson, R. H., Razavi, R., & Taylor, A. M. (2004). Cardiac anatomy revisited. Journal of anatomy, 205(3), 159–177. doi:10.1111/j.0021-8782.2004.00330.x

                                    <br>-King J, Lowery DR. Physiology, Cardiac Output. [Updated 2019 May 7]. In: StatPearls [Internet]. Treasure Island (FL): StatPearls Publishing; 2019 Jan-. Available from:<a style="color: red !important" href="https://www.ncbi.nlm.nih.gov/books/NBK470455/"  target="_blank"> https://www.ncbi.nlm.nih.gov/books/NBK470455/</a>

                                    <br>-Rehman S, Rehman A. Physiology, Coronary Circulation. [Updated 2019 Jan 13]. In: StatPearls [Internet]. Treasure Island (FL): StatPearls Publishing; 2019 Jan-. Available from: <a style="color: red !important" href="https://www.ncbi.nlm.nih.gov/books/NBK482413/" target="_blank"> https://www.ncbi.nlm.nih.gov/books/NBK482413/ </a>
                            </p>
                        </div>
                    </div>
                </div>
